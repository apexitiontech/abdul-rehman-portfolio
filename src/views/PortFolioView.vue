            ...
            <div class="row g-6 g-md-8">
              <div data-aos="fade-up" data-aos-duration="800" class="col-xl-6">
                <div class="project-card">
                  <RouterLink  :to="`/portfolio/34`"  class="thumb d-block">
                    <div class="post-thumb">
                      <div class="post-thumb-inner">
                        <img src="@/assets/images/project1.png" alt="..." class="w-100 p-2" />
                      </div>
                    </div>
                    <div class="post-thumb">
                      <div class="post-thumb-inner">
              ...
              <div data-aos="fade-up" data-aos-duration="800" class="col-xl-6">
                <div class="project-card">
                  <RouterLink  :to="`/portfolio/34`"  class="thumb d-block">
                    <div class="post-thumb">
                      <div class="post-thumb-inner">
                        <img src="@/assets/images/project2.png" alt="..." class="w-100 p-2" />
                      </div>
                    </div>
                    <div class="post-thumb">
                      <div class="post-thumb-inner">
              ...
              <div data-aos="fade-up" data-aos-duration="700" class="col-xl-6">
                <div class="project-card">
                  <RouterLink  :to="`/portfolio/34`"  class="thumb d-block">
                    <div class="post-thumb">
                      <div class="post-thumb-inner">
                        <img src="@/assets/images/project3.png" alt="..." class="w-100 p-2" />
                      </div>
                    </div>
                    <div class="post-thumb">
                      <div class="post-thumb-inner">
              ...
              <div data-aos="fade-up" data-aos-duration="800" class="col-xl-6">
                <div class="project-card">
                  <RouterLink  :to="`/portfolio/34`"  class="thumb d-block">
                    <div class="post-thumb">
                      <div class="post-thumb-inner">
                        <img src="@/assets/images/project4.png" alt="..." class="w-100 p-2" />
                      </div>
                    </div>
                    <div class="post-thumb">
                      <div class="post-thumb-inner">
