<template>
  ...
  <section class="pt-120  br-bottom-n3  pb-10">
    <div class="pb-60 br-bottom-n3">
      <div data-aos="zoom-in" class="page-heading">
        ...
        <p class="fs-seven n5-color mb-4 mb-md-8 text-center">
          ...
          the web and mobile devices. You can take a look at my and
    ...
    <div class="container mt-8 mt-md-15">
      ...
      <div data-aos="zoom-in" class="hire-content mt-2 mt-md-15">
      ...
      <div class="row mt-8 mt-md-15 justify-content-between g-6">
        <div class="col-12 col-md-12 col-xl-6">
          <div class="accordion-section d-grid gap-2 gap-md-4">
            <div v-for="(faq, index) in faqs" :key="index" class="accordion-single"
              ...
              <h5 class="header-area p-2 p-sm-4 p-md-8">
                <button
                  ...
                  type="button" @click="toggleAccordion(index)">
                  <span class="faq_icon_width d-flex flex-shrink-0 align-items-center justify-content-between n2-color">
                    <i class="ph ph-arrow-right"></i>
                  </span>
                  {{ faq.title }}
                </button>
              </h5>
              <div class="content-area overflow-hidden" :style="{ display: activeIndex === index ? 'block' : 'none' }">
